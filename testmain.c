...
void main() {
  ...
  printf("\t\t\t|                              &                               "
         "     |\n");
  printf("\t\t\t|                          Belarbi Anes Abdlemalek             "
         "     |\n");
  printf("\t\t\t|                                                              "
         "     |\n");
  printf("\t\t\t|                                                              "
  ...
  printf("\t\t\t| Note !! Click Enter To Access The menu  .                    "
         "                         |\n");
  printf("\t\t\t| To choose your option, press the corresponding number on the "
         "keyboard.                |\n");
  printf("\t\t\t|______________________________________________________________"
  ...
  case 13:
    ...
    printf("\t\t\t| Note !! The Last Three Operations  only Admin Can Uses "
           "Adim.                          |\n");
    ...
    printf("\t\t\t| Check The Total Amount of an Account : Click 4.            "
           "                           |\n");
    printf("\t\t\t| Check the history of bank transactions within a given date "
           ": Click 5.                 |\n");
    ...
    while (x > 7 && x < 1) {
      printf(
          "please Enter your choise The number must be between 1 and 6 . \n ");
      scanf("%i", &x);
    }
    switch (x) {
    case 1:
      ...
      for (int i = 0; i < 3; i++) {
        ...
        TransferAmount(p, SenderNum, ReceiverNum, Amount,
                       D); // call the function
      }
